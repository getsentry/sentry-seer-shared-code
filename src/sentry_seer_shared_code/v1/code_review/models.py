...
from sentry_seer_shared_code.v1.seer.models import SeerRepoDefinition  # noqa: TC001
...
class SeerCodeReviewRequestForPrReview(BaseModel):
    ...
    Now maintained in: sentry-seer-shared-code as the shared source of truth
    """

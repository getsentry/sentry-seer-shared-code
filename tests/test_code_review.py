...
Validates the structure of payloads and models used in the Sentry to Seer code review
integration, including SeerRepoDefinition, config, and request types.
"""
